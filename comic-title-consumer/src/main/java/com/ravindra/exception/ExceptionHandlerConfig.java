...
public class ExceptionHandlerConfig extends ResponseEntityExceptionHandler {
	 ...
	 * @return ResponseEntity<ErrorDetails>
	 */
	@ExceptionHandler(ComicServiceNotFoundException.class)
	public ResponseEntity<ErrorDetails> handleComicServiceNotFoundException(ComicServiceNotFoundException e) {
